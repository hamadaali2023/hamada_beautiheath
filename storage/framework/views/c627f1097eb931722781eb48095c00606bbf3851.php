                ...
                <li class="breadcrumb-item">
                    ...
                    <div class="col-sm-5 col">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('اضافة صلاحية')): ?>
                             <a href="<?php echo e(route('roles.create')); ?>" class="btn btn-primary float-right mt-2">إضافة صلاحية</a>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layout.admin_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/admin/roles/index.blade.php ENDPATH**/ ?>