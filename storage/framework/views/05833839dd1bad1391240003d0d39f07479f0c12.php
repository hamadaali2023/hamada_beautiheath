	                        ...
	                        <div class="card-body">
	                            <div class="table-responsive">
	                                <table class="table table-striped table-bordered keytable-integration">
	                                    <thead>
											<tr>	
												<th class="text-center">وقت العمل</th>
										...
										<tbody>
											<?php $__currentLoopData = $work_days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr>
													<!-- <td>
													...
													<td class="text-center">
														 من <?php echo e($_item->time->from_time); ?> إلى <?php echo e($_item->time->to_time); ?>

													</td>
													<td class="text-center">
														<?php if($_item->day->sat==1): ?>
														السبت -
														<?php endif; ?>
														<?php if($_item->day->sun==1): ?>
														الاحد -
														<?php endif; ?>
														<?php if($_item->day->mon==1): ?>
														الاثنين -
														<?php endif; ?>
														<?php if($_item->day->tus==1): ?>
														الثلاثاء -
														<?php endif; ?>
														<?php if($_item->day->wed==1): ?>
														الاربعاء -
														<?php endif; ?>
														<?php if($_item->day->thu==1): ?>
														الخميس -
														<?php endif; ?>
														<?php if($_item->day->fri==1): ?>
														الجمعة
														<?php endif; ?>
													</td>
													
													<td class="text-center">
														<?php echo e($_item->day->sat); ?>
...
<?php echo $__env->make('layout.doctors.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/doctors/work_days/all.blade.php ENDPATH**/ ?>