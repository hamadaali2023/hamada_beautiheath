    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="nav-item <?php echo e(Request::is('/') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/admin/dashboard')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الرئيسية</span></a>
        </li>
        ...
        <li class="nav-item <?php echo e(Request::is('subcategories') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/subcategories')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الخدمات الفرعية</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('all-doctor-orders') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/all-doctor-orders')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">طلبات مقدم الخدمات</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('all-vendor-orders') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/all-vendor-orders')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">طلبات المتجر</span></a>
        </li>
        ...
        <li class="nav-item <?php echo e(Request::is('shops') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/shops')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">التجار</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('patients') ? 'active' : ''); ?>">
         ...
         <li class="nav-item <?php echo e(Request::is('banks') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/banks')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الحسابات البنكية</span></a>
        </li>
        ...
        <li   class="<?php echo e(Request::is('vendor-notifaction') ? 'active' : ''); ?>"> 
            <a href="<?php echo e(url('vendor-notifaction')); ?>"><i class="la la-envelope"></i> <span class="menu-title">ارسال اشعارات للمتاجر</span></a>
        </li>
          ...
          <ul class="menu-content">
            ...
            <li  class="<?php echo e(Request::is('contact') ? 'active' : ''); ?>"> 
             ...
             <li  class="<?php echo e(Request::is('terms') ? 'active' : ''); ?>"> 
                <a class="menu-item" href="<?php echo e(url('terms')); ?>" data-i18n="nav.flot_charts.flot_pie_charts">الشروط والتعليمات</a>
            </li>
             <li  class="<?php echo e(Request::is('return_policy') ? 'active' : ''); ?>"> 
                <a class="menu-item" href="<?php echo e(url('return_policy')); ?>" data-i18n="nav.flot_charts.flot_pie_charts">سياسة الإرجاع</a>
            </li>
            <!--<li  class="<?php echo e(Request::is('agreements') ? 'active' : ''); ?>"> -->
            <!--    <a class="menu-item" href="<?php echo e(url('agreements')); ?>" data-i18n="nav.flot_charts.flot_pie_charts">إتفاقية المدرب</a>-->
            <!--</li>-->
            <!-- <li  class="<?php echo e(Request::is('agreement_student') ? 'active' : ''); ?>"> -->
            <!--    <a class="menu-item" href="<?php echo e(url('agreement_student')); ?>" data-i18n="nav.flot_charts.flot_pie_charts">إتفاقية الطالب</a>-->
            <!--</li>-->
          </ul>
        </li>
 ...
 -->
  ...
  </div><?php /**PATH /home/findfamily/public_html/resources/views/layout/admin_sidbar.blade.php ENDPATH**/ ?>