 <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="index.html">
              ...
              <h3 class="brand-text"> kutuphanah</h3>
            </a>
          </li>
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">
                  ...
                  <span class="user-name text-bold-700">
                    <?php
                      $instructors=Auth::guard('doctors')->user();
                    ?>
                    <?php echo e($instructors->name); ?>
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="<?php echo e(route('signoutdoctors')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> تسجيل الخروج </a>
                <form id="logout-form" action="<?php echo e(route('signoutdoctors')); ?>" method="POST" class="d-none">
                  <?php echo csrf_field(); ?>
                </form>
            ...
            <li class="dropdown dropdown-notification nav-item">
              <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow"><?php echo e($not_doctor_count); ?></span>
              </a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                  ...
                  <span class="notification-tag badge badge-default badge-danger float-right m-0"><?php echo e($not_doctor_count); ?> New</span>
                </li>
                <li class="scrollable-container media-list w-100">
                  
                  <?php $__currentLoopData = $patient_notifications_doctor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <?php $__currentLoopData = $_patient->unreadnotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_patients): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <a href="<?php echo e(url('view/notification/'.$_patients->id)); ?>">
                        <div class="media">
                          <div class="media-left align-self-center">
                            <?php if($_patient->photo !=null): ?>
                              <img class="avatar-img rounded-circle" alt="User Image" src="<?php echo e(asset('assets_admin/img/patient/'.$_patient->photo)); ?>"  width="50px">
                            <?php else: ?>                                      
                              <img class="avatar-img rounded-circle" alt="User Image" src="<?php echo e(asset('assets_admin/img/profile_image.png')); ?>" width="50px">
                            <?php endif; ?>

                            <!--<i class="ft-plus-square icon-bg-circle bg-cyan"></i>-->
                          </div>
                          <div class="media-body">
                            <h6 class="media-heading"> حجز جديد من <?php echo e($_patients->data['name']); ?></h6>
                            <p class="notification-text font-small-3 text-muted"><?php echo e($_patients->data['message']); ?>:</p>
                            <small>
                              <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00"><?php echo e($_patients->data['orderId']); ?></time>
                            </small>
                          </div>
                        </div>
                      </a>
      ...
      </div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/layout/doctors/nav.blade.php ENDPATH**/ ?>