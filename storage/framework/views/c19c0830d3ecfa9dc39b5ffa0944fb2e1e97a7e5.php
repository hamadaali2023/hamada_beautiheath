                    ...
                    <div class="card-body">
						<div class="table-responsive">
		                    <table class="table table-striped table-bordered keytable-integration">
											...
											<?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr>													
													<td class="text-center">
														<img class="avatar-img" src="<?php echo e(asset('assets_admin/img/subcategory/'.$_item->icon)); ?>" alt="Speciality" width="50" height="50">
													</td>
													<td class="text-center">
														<img class="avatar-img" src="<?php echo e(asset('assets_admin/img/subcategory/'.$_item->image)); ?>" alt="Speciality" width="50" height="50">
													</td>
													<td class="text-center">
													...
													<td class="text-center">
														<div class="actions">
															...
															<a class="btn btn-sm bg-success-light" href="<?php echo e(url('subcategories/'.$_item->id).'/edit'); ?>"><i class="fe fe-pencil"></i> تعديل</a>
								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="title_en" class="form-control" value="<?php echo e(old('title_ar')); ?>">
										</div>
									</div>
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							 ...
							 <form  method="post" action="<?php echo e(route('subcategories.update','test')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="<?php echo e(route('subcategories.destroy','test')); ?>">
	                                   		 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.admin_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/beauty/resources/views/admin/subcategories/all.blade.php ENDPATH**/ ?>