...
<?php endif; ?>
  ...
  <script src="<?php echo e(asset('admin/vendors/js/gallery/photo-swipe/photoswipe.min.js')); ?>"
  type="text/javascript"></script>
  <script src="<?php echo e(asset('admin/vendors/js/gallery/photo-swipe/photoswipe-ui-default.min.js')); ?>"
  type="text/javascript"></script>

  <script src="<?php echo e(asset('admin/js/scripts/gallery/photo-swipe/photoswipe-script.js')); ?>"  type="text/javascript"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/layout/instructor/footer.blade.php ENDPATH**/ ?>