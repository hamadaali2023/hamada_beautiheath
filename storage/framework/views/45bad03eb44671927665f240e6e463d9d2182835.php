            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                      ...
                      <?php endif; ?>
                            ...
                            <?php endif; ?> 
                    <form class="form-horizontal form-simple"  novalidate method="POST" action="<?php echo e(route('doctorlogin')); ?>">
                       				 <?php echo csrf_field(); ?>
                      ...
                      <div class="form-group row">
                        ...
                        <!--  </fieldset>-->
                        <!--</div>-->
                        <div class="col-md-6 col-12 text-center text-md-left"><a href="<?php echo e(url('doctor/forgot-password')); ?>" class="card-link">نسيت كلمة السر ؟</a></div>                      </div>
                ...
                <div class="card-footer">
                  <div class="">
                     <p>ليس لديك حساب ؟ <a href="<?php echo e(url('doctor-signup')); ?>" class="main-color font-weight-bold">تسجيل عضوية جديدة</a>
...
<?php echo $__env->make('layout.doctors.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/resources/views/doctors/login.blade.php ENDPATH**/ ?>