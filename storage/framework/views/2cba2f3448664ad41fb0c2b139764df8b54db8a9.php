 <div class="navbar-header">
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-notification nav-item">
              <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow"><?php echo e($count); ?></span>
              </a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                  ...
                  <span class="notification-tag badge badge-default badge-danger float-right m-0"><?php echo e($count); ?> New</span>
                </li>
                <li class="scrollable-container media-list w-100">
                  ...
                  <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    ...
                    <!--<?php echo e(url('view/notification/'.$_item->id)); ?>-->
                      <a href="#">
                        <div class="media">
                          <div class="media-left align-self-center">
                            <?php if($_item->photo !=null): ?>
                              <img class="avatar-img rounded-circle" alt="User Image" src="<?php echo e(asset('assets_admin/img/patient/'.$_item->photo)); ?>" width="50px">
                            <?php else: ?>                                      
                          ...
                          <div class="media-body">
                            <h6 class="media-heading"> new order <?php echo e($_item->name); ?></h6>
                            <p class="notification-text font-small-3 text-muted"><?php echo e($_items->data['message']); ?>:</p>
                            <small>
                              <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00"><?php echo e($_items->data['orderId']); ?></time>
                            </small>
                          </div>
                        </div>
                      </a>
                       ...
                       <a href="#">
                        <div class="media">
                          ...
                          <div class="media-body">
                            ...
                            <p class="notification-text font-small-3 text-muted"><?php echo e($_patients->data['name']); ?>:</p>
                            <small>
      ...
      </div><?php /**PATH /home/beaunqrp/public_html/resources/views/layout/admin_nav.blade.php ENDPATH**/ ?>