 <div class="navbar-header">
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">
                  ...
                  <span class="user-name text-bold-700">
                    <?php
                      $instructors=Auth::guard('vendors')->user();
                    ?>
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="<?php echo e(route('signoutinstructors')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> تسجيل الخروج </a>
                <form id="logout-form" action="<?php echo e(route('signoutinstructors')); ?>" method="POST" class="d-none">
                  <?php echo csrf_field(); ?>
                </form>
            ...
            <li class="dropdown dropdown-notification nav-item">
              <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow"><?php echo e($not_vedor_count); ?></span>
              </a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                  ...
                  <span class="notification-tag badge badge-default badge-danger float-right m-0"><?php echo e($not_vedor_count); ?> New</span>
                </li>
                <li class="scrollable-container media-list w-100">
                  
                  
 
                  <?php $__currentLoopData = $notifications_vendor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                       ...
                       <a href="<?php echo e(url('view/notification/'.$_patients->id)); ?>">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <h6 class="media-heading"> حجز جديد من <?php echo e($_patients->name); ?></h6>
      ...
      </div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/layout/instructor/nav.blade.php ENDPATH**/ ?>