											...
											<tbody>
												...
												<tr>
													...
													<td class="text-center">	
														<a href="<?php echo e(url('vendor-profile/'.$_item->id)); ?>"> 
														<?php if($_item->photo!=null): ?>
															<img class="avatar-img rounded-circle" 
																src="<?php echo e(asset('assets_admin/img/vendors/'.$_item->photo)); ?>" alt="User Image" width="60px" height="60px">
														<?php else: ?>
														    <img class="avatar-img rounded-circle" 
																src="<?php echo e(asset('assets_admin/img/vendors/photo/profile.png')); ?>" alt="User Image" width="60px" height="60px">
														<?php endif; ?>
														</a>			
													</td>
													<td class="text-center">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="<?php echo e(route('shops.destroy','test')); ?>">
	                                   		 <?php echo csrf_field(); ?>
		        ...
		        $(document).ready(function(){
		            $('.js-switch').change(function () {
		                ...
		                $.ajax({
		                    type: "GET",
		                    dataType: "json",
		                    url: '<?php echo e(route('vendors_update_status')); ?>',
...
<?php echo $__env->make('layout.admin_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/beauty/resources/views/admin/vendors/all.blade.php ENDPATH**/ ?>