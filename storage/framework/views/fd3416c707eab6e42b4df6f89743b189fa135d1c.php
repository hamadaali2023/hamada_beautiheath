<?php $__env->startSection('content'); ?>	
		...
		<div class="content-header row">
	        ...
	        <div class="dropdown float-md-right">
		        <a href="<?php echo e(route('services.create')); ?>"  class="btn btn-primary float-right mt-2">إضافة خدمة </a>
		    </div>
		</div>
												...
												<tr>
													...
													<td>
														<a href="profile" class="avatar avatar-sm mr-2">
					                                        <img class="avatar-img" src="<?php echo e(asset('assets_admin/img/categories/'.$_item->categoryname->icon)); ?>" alt="Speciality">
					                                    </a>
													</td>
...
<?php echo $__env->make('layout.doctors.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/doctors/services/all.blade.php ENDPATH**/ ?>