								...
								<div class="row form-row">
			                        ...
			                        <div class="col-md-6 col-sm-3">
										<div class="form-group">
						                    ...
						                    <select name="companies_insuranceId" class="form-control" placeholder="Select " >
				                            ...
				                            <option value="<?php echo e($_item->id); ?>" <?php echo e(old('companies_insuranceId') == $_item->id ? "selected" : ""); ?>><?php echo e($_item->name_ar); ?>
...
unset($__errorArgs, $__bag); ?>
								...
								<button type="submit" class="btn btn-primary btn-block">إضافة تأمين </button>
							</form>
						</div>
					</div>
				</div>
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="<?php echo e(route('insurances.destroy','test')); ?>">
	                                   		 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.doctors.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/doctors/insurances/all.blade.php ENDPATH**/ ?>