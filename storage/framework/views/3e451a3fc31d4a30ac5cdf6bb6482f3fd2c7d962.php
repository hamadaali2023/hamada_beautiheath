    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item <?php echo e(Request::is('doctor/orders') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('doctor/orders')); ?>">
 ...
 -->
  ...
  </div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/layout/doctors/sidbar.blade.php ENDPATH**/ ?>