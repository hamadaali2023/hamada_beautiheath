							...
							<?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>																			
									<td class="text-center">						
										<a href="<?php echo e(url('all-doctor-order-details/'.$_item->id)); ?>"><?php echo e($_item->id); ?></a>
									</td>
									<td class="text-center">						
...
<?php echo $__env->make('layout.admin_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/heeeelthy/resources/views/admin/orders/all.blade.php ENDPATH**/ ?>