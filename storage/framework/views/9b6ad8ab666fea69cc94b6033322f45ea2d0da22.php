<?php $__env->startSection('content'); ?>	
		...
		<div class="content-header row">
	        ...
	        <div class="dropdown float-md-right">
		        <a href="<?php echo e(route('products.create')); ?>"  class="btn btn-primary float-right mt-2">إضافة منتج جديد</a>
		    </div>
		</div>
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="<?php echo e(route('products.destroy','test')); ?>">
	                                   		 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.instructor.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/beauty/resources/views/vendors/products/all.blade.php ENDPATH**/ ?>