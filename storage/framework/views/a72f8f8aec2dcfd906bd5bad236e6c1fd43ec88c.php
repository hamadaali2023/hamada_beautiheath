                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal form-simple"  novalidate method="POST" action="<?php echo e(route('userlogin')); ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <!--  </fieldset>-->
                        <!--</div>-->
                          <div class="col-md-6 col-12 text-md-left"><a href="<?php echo e(url('vendor/forgot-password')); ?>" class="card-link">نسيت كلمة السر؟</a></div>
                      </div>
...
<?php echo $__env->make('layout.instructor.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/resources/views/vendors/login.blade.php ENDPATH**/ ?>