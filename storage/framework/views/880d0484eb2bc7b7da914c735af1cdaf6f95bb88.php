          ...
          <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-company-details" class="row">
              ...
              <div class="col-md-4 col-sm-12 text-center text-md-left">
                ...
                <p class="text-bold-800">اسم العميل(طالب الخدمة) : <?php echo e($patient->first_name); ?></p>
               
              </div>
              <div class="col-md-4 col-sm-12 text-center text-md-left">
                <img src="<?php echo e(asset('assets_admin/img/settings/'.$contact->logo)); ?>" width="100px" alt="company logo" class=""/ style="float: left;">
              </div>
              ...
              <div class="col-md-4 col-sm-12 text-center text-md-left">
                      <?php $__currentLoopData = $patient_location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient_location_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p>الدولة: <?php echo e($patient_location_item->country); ?>,</p>
                        <p>المدينة:<?php echo e($patient_location_item->city); ?>,</p>
                        <p>اسم اللوكشن<?php echo e($patient_location_item->location_name); ?>,</p>
                        <p>الشارع: <?php echo e($patient_location_item->street); ?>,</p>
                        <p>المبنى:<?php echo e($patient_location_item->building_name); ?>,</p>
                        <p>رقم الطابق:<?php echo e($patient_location_item->floor_number); ?>,</p>
...
<?php echo $__env->make('layout.instructor.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/beauty/resources/views/vendors/orders/order-details.blade.php ENDPATH**/ ?>