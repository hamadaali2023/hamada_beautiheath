              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <?php if(Session::has('errorss')): ?>    
                        <div class="row mr-2 ml-2" >
                                <button type="text" class="btn btn-lg text-left btn-block btn-outline-danger mb-2"id="type-error">
                                   <?php echo e(Session::get('errorss')); ?>
                    ...
                    <form class="form-horizontal form-simple"  novalidate method="POST" action="<?php echo e(route('create_vendor')); ?>">
                       				 <?php echo csrf_field(); ?>
                      
                      <div class="form-group">
                            <i class="fas fa-user icon"></i>
                            <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="الاسم">
...
unset($__errorArgs, $__bag); ?>>
                 ...
                 <div class="text-center">
                        <p>لديك حساب بالفعل ؟ <a href="<?php echo e(url('user-login')); ?>" class="main-color font-weight-bold">تسجيل الدخول</a>
                        </p>
                    </div>
...
<?php echo $__env->make('layout.instructor.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/resources/views/vendors/signup.blade.php ENDPATH**/ ?>