	...
	<div class="content-header row">
		...
		<div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="<?php echo e(url('cities')); ?>"  class="btn btn-primary float-right mt-2">رجوع</a>
            </div>
        </div>
...
<?php echo $__env->make('layout.admin_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/heeeelthy/resources/views/admin/cities/edit.blade.php ENDPATH**/ ?>