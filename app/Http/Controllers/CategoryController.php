...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate( $request,[          
            ...
            [
                'name_ar.required'=>'يرجى ادخال اسم الخدمة عربي',
                'name_en.required'=>' يرجى ادخال اسم الخدمة انجليزي ',
                'description_ar.required'=>'يرجى كتابة وصف الخدمة عربي',
                'description_en.required'=>' يرجى كتابة وصف الخدمة انجليزي ',
                'icon.required'=>' يرجي إختيار صورة jpeg,jpg,png,gif ',
                'image.required'=>' يرجي إختيار صورة jpeg,jpg,png,gif ',
                'color.required'=>' يرجى ادخال لون الخدمة ',
    ...
    public function destroy(Request $request )
    {
        ...
        if(count($appointment) == 0){
           ...
           return redirect()->back()->with("error", 'غير مسموح حذف هذا العنصر لأنه يحتوي على خدمات فرعية'); 
        }        
    } 
}
