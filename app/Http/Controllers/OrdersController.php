...
class OrdersController extends Controller
{
    ...
    {   
        ///// dd('uyvuyghvyhc');
        $orders=Order::where('doctorId','!=',null)->get();
    ...
    {   
        ///// dd('uyvuyghvyhc');
        $orders=Order::where('vendorId','!=',null)->get();
        foreach($orders as $item){
            $item->category=Category::where('id',$item->categoryId)->first();
    ...
    public function vendorOrderDetails($orderId)
    {   
        ...
        return view('admin.orders.vendor-order-details',compact('order','category','patient','subcategory','doctor_service_price_total','order_sub_category','products','alldoctors_for_this_services','patient_location'));
