...
class ChatsController extends Controller
{
        ...
        public function doctorChat(Request $request)
        {
            if($request->doctorId !=null){
                ...
                foreach ($chats as $item) {
                    ...
                    $patient->photo="https://beautiheath.com/assets_admin/img/patients/".$patient->photo; 
                ...
                foreach ($chats as $item) {
                    ...
                    $doctor->photo="https://beautiheath.com/assets_admin/img/doctors/photo/".$doctor->photo; 
                    $item->doctor= $doctor; 
                    $item->messages= Message::where('chatID',$item->id)->first();       
                }
        ...
        public function usersGetMessages(Request $request)
        {
            ...
            {
                $item->file="https://beautiheath.com/assets_admin/img/chats/".$item->file;
            } 
