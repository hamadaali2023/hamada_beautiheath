...
{  
    ...
    {   
        ...
        foreach($orders as $item){
            ...
            $patient->photo= "http://beautiheath.com/assets_admin/img/patient/".$patient->photo;
            $item->patient=$patient;
            $doctor = Doctor::where('id',$item->doctorId)->first();
            if($doctor){
                $doctor->photo= "http://beautiheath.com/assets_admin/img/doctors/photo/".$doctor->photo;
            }
            $item->doctor=$doctor;
        ...
        // subcategory
            ...
            foreach ($products as $product_item) {
                $product_item->image="http://beautiheath.com/assets_admin/img/products/".$product_item->image;
            }
    ...
    //         $item->photo="https://findfamily.net/beauty/assets_admin/img/vendors/".$item->photo;
    //     }    
    //     return $this -> returnDataa(
    //         'data',$vendors,'riuhfer'
    //     );
    // }
    ...
    {    
        $categotries = Category::selection()->get();
        foreach ($categotries as $item) {
            $item->icon="http://beautiheath.com/assets_admin/img/categories/".$item->icon;
    ...
    public function subcategory(Request $request)
    {
        ...
        foreach ($subcategory as $item) {
            $item->icon="http://beautiheath.com/assets_admin/img/subcategory/".$item->icon;
        }
    ...
    {    
        ...
        $contactinfo->logo="http://beautiheath.com/assets_admin/img/settings/".$contactinfo->logo;
        $contactinfo->mesion_image="http://beautiheath.com/assets_admin/img/settings/".$contactinfo->mesion_image;
        $contactinfo->vesion_image="https://findfamily.net/care/assets_admin/img/settings/".$contactinfo->vesion_image;
        $contactinfo->favicon="http://beautiheath.com/assets_admin/img/settings/".$contactinfo->favicon;
