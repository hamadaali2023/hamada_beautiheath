...
class DoctorController extends Controller
{
    ...
    public function profile($doctor)
    {
        ...
        $countries=Country::all();
        $cities=City::all();
        $work_days=Work_days::where('doctorId',$doctor)->first();
        // dd($work_days);
            $work_days->day= Day::where('work_dayId',$work_days->id)->first();
            $work_days->time= Time::where('work_dayId',$work_days->id)->first();
            
        $licenses=Doctor_license::where('doctorId',$doctor)->first();
        
        
        $doctor_educations=Doctor_education::where('doctorId',$doctor)->get();
       
       
        $doctor_experiences=Doctor_experience::where('doctorId',$doctor)->get();
        $insurances=Doctor_insurance::where('doctorId',$doctor)->get();
        ...
        $doctor_languages=Doctor_language::where('doctorId',$doctor)->get();
        ...
        $orders=Order::where('doctorId',$doctor)->get();
        ...
        $doctors_services=Doctor_service::where('doctorId',$doctor)->get();
        ...
        return view('admin.doctors.doctor-profile',compact(
            ...
            'work_days',
            'doctor_experiences',
            'insurances','companies_insurance',
