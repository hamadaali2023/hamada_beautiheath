...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        $users=Vendor::findOrFail($userid->id);
        $country=Country::where('id',$userid->countryId)->first();
        $users->country=$country->name_ar;
        return view('vendors.profile',compact('users','countries'));
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        $edit = Vendor::findOrFail($userid->id);
    ...
    {        
        ...
        return view('vendors.bank.edit',compact('bankdetails','country','cities'));
    }
