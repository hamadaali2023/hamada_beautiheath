...
@section('content')	
		...
		<div class="content-header row">
	        ...
	        <div class="dropdown float-md-right">
		        <a href="{{route('services.create')}}"  class="btn btn-primary float-right mt-2">إضافة خدمة </a>
		    </div>
		</div>
												...
												<tr>
													...
													<td>
														<a href="profile" class="avatar avatar-sm mr-2">
					                                        <img class="avatar-img" src="{{asset('assets_admin/img/categories/'.$_item->categoryname->icon) }}" alt="Speciality">
					                                    </a>
													</td>
