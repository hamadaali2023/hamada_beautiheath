								...
								<div class="row form-row">
									...
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="job_desc" class="form-control" value="{{old('job_desc')}}">
										</div>
									</div>
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							 ...
							 <form  method="post" action="{{route('experiences.update','test')}}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="{{route('experiences.destroy','test')}}">
	                                   		 @csrf
	                                         @method('delete')
	                                         <input type="hidden" name="id" id="cat_id">
