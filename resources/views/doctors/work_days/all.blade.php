...
@section('content')	
		...
		<div class="content-header row">
	        ...
	        <div class="dropdown float-md-right">
		        <a href="{{route('products.create')}}"  class="btn btn-primary float-right mt-2">إضافة خدمة </a>
		    </div>
		</div>
											...
											@foreach ($work_days as $_item)
												<tr>
													...
													<td class="text-center">
														 من {{$_item->time->from_time}} إلى {{$_item->time->to_time}}
													</td>
													<td class="text-center">
														@if($_item->day->sat==1)
														السبت -
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="{{route('services.destroy','test')}}">
	                                   		 @csrf
	                                         @method('delete')
