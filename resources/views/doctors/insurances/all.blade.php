								...
								<div class="row form-row">
			                        ...
			                        <div class="col-md-6 col-sm-3">
										<div class="form-group">
				                            ...
				                            <option value="{{$_item->id}}" {{ old('companies_insuranceId') == $_item->id ? "selected" : "" }}>{{$_item->name_ar}}
				                            </option>
				                            @endforeach
						                    </select>
						                    @error('companies_insuranceId')
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="{{route('insurances.destroy','test')}}">
	                                   		 @csrf
	                                         @method('delete')
