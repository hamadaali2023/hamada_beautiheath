											...
											<tbody>
												...
												<tr>
													...
													<td class="text-center">	
														<a href="{{url('vendor-profile/'.$_item->id) }}"> 
														@if($_item->photo!=null)
															<img class="avatar-img rounded-circle" 
																src="{{asset('assets_admin/img/vendors/'.$_item->photo) }}" alt="User Image" width="60px" height="60px">
														@else
														    <img class="avatar-img rounded-circle" 
																src="{{asset('assets_admin/img/vendors/photo/profile.png') }}" alt="User Image" width="60px" height="60px">
														@endif
														</a>			
													</td>
													<td class="text-center">
		        ...
		        $(document).ready(function(){
		            $('.js-switch').change(function () {
		                ...
		                $.ajax({
		                    type: "GET",
		                    dataType: "json",
		                    url: '{{ route('vendors_update_status') }}',
