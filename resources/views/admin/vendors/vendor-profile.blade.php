                    ...
                    <div class="profile-header">
                        <div class="row align-items-center">
                            <div class="col-auto profile-image">
                                <a href="#">
                                    <img class="rounded-circle" alt="User Image" src="{{asset('assets_admin/img/vendors/'.$vendors->photo) }}" width="50px">
                                </a>
                            </div>
                            <div class="col ml-md-n2 profile-user-info">
                               <h4 class="user-name mb-0"> {{$vendors->email }}</h4>
                                    <h6 class="text-muted"> {{$vendors->mobile }}</h6>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10 col-lg-6">
                                            ...
                                            @csrf
                                                <input type="hidden" name="patientId" value="{{$vendors->id}}">
                                                <div class="form-group">
									...
									@foreach ($orders as $_item)
										<tr>
											<td class="text-center">						
												<a href="{{url('all-vendor-order-details/'.$_item->id) }}">{{$_item->id}}</a>
											</td>
											<td class="text-center">						
												...
												<tr>
													...
													<td class="text-center">
														<div class="actions">
				                                        	...
				                                        	<!-- <a  href="{{url('products/sizes')}}" class="delete-course">
				                                           		<button type="button" class="btn btn-outline-success ">الاحجام</button>
				                                        	</a>
				                                        	<a href="{{url('products/colors')}}" class="delete-course">
