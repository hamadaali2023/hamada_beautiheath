          ...
          <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-company-details" class="row">
              ...
              <div class="col-md-4 col-sm-12 text-center text-md-left">
                ...
                <p class="text-bold-800">اسم العميل(طالب الخدمة) : {{$patient->first_name}}</p>
               
              </div>
              <div class="col-md-4 col-sm-12 text-center text-md-left">
                <img src="{{asset('assets_admin/img/settings/'.$contact->logo) }}" width="100px" alt="company logo" class=""/ style="float: left;">
              </div>

              <div class="col-md-4 col-sm-12 text-center text-md-left">
                      @foreach ($patient_location as $patient_location_item)
                        <p>الدولة: {{$patient_location_item->country}},</p>
                        <p>المدينة:{{$patient_location_item->city}},</p>
                        <p>اسم اللوكشن{{$patient_location_item->location_name}},</p>
                        <p>الشارع: {{$patient_location_item->street}},</p>
                        <p>المبنى:{{$patient_location_item->building_name}},</p>
                        <p>رقم الطابق:{{$patient_location_item->floor_number}},</p>
                      @endforeach  
              </div>
