...
<section id="basic-form-layouts">
         ...
         <!--                 <option value="{{$_item->id}}" {{($_item->id==$product->categoryId) ? 'selected' : '' }}>{{$_item->name_ar}}-->
         <!--                 </option>-->
         <!--               @endforeach-->
									<!--		</select>-->
									<!--	</div>-->
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                      ...
                      <!-- <input type="text" name="description_ar" class="form-control" value="{{$product->description_ar}}"> -->
                      <textarea name="description_ar" id="des" cols="10" rows="3"  class="form-control ">{{$product->description_ar}}</textarea>
                    </div>
                  </div>
                  <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                      ...
                      <textarea name="description_en" id="des" cols="10" rows="3"  class="form-control ">{{$product->description_en}}</textarea>
                    </div>
                  </div>
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
