    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item {{ Request::is('subcategories') ? 'active' : '' }}">
            <a href="{{url('/subcategories')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الخدمات الفرعية</span></a>
        </li>
        <li class="nav-item {{ Request::is('all-doctor-orders') ? 'active' : '' }}">
            <a href="{{url('/all-doctor-orders')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">طلبات مقدم الخدمات</span></a>
        </li>
        <li class="nav-item {{ Request::is('all-vendor-orders') ? 'active' : '' }}">
            <a href="{{url('/all-vendor-orders')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">طلبات المتجر</span></a>
        </li>
        ...
        <li class="nav-item {{ Request::is('shops') ? 'active' : '' }}">
            <a href="{{url('/shops')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">التجار</span></a>
        </li>
        <li class="nav-item {{ Request::is('patients') ? 'active' : '' }}">
         ...
         <li class="nav-item {{ Request::is('banks') ? 'active' : '' }}">
            <a href="{{url('/banks')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الحسابات البنكية</span></a>
        </li>
        ...
        <li   class="{{ Request::is('vendor-notifaction') ? 'active' : '' }}"> 
            <a href="{{url('vendor-notifaction')}}"><i class="la la-envelope"></i> <span class="menu-title">ارسال اشعارات للمتاجر</span></a>
        </li>
          ...
          <ul class="menu-content">
            ...
            <li  class="{{ Request::is('contact') ? 'active' : '' }}"> 
             ...
             <li  class="{{ Request::is('terms') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('terms')}}" data-i18n="nav.flot_charts.flot_pie_charts">الشروط والتعليمات</a>
            </li>
             <li  class="{{ Request::is('return_policy') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('return_policy')}}" data-i18n="nav.flot_charts.flot_pie_charts">سياسة الإرجاع</a>
            </li>
            <!--<li  class="{{ Request::is('agreements') ? 'active' : '' }}"> -->
            <!--    <a class="menu-item" href="{{url('agreements')}}" data-i18n="nav.flot_charts.flot_pie_charts">إتفاقية المدرب</a>-->
            <!--</li>-->
            <!-- <li  class="{{ Request::is('agreement_student') ? 'active' : '' }}"> -->
            <!--    <a class="menu-item" href="{{url('agreement_student')}}" data-i18n="nav.flot_charts.flot_pie_charts">إتفاقية الطالب</a>-->
            <!--</li>-->
          </ul>
        </li>
