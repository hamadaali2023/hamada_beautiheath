          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-notification nav-item">
              <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i>
                <span class="badge badge-pill badge-default badge-danger badge-default badge-up badge-glow">{{$not_vendor_count}}</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                <li class="dropdown-menu-header">
                  ...
                  <span class="notification-tag badge badge-default badge-danger float-right m-0">{{$not_vendor_count}} New</span>
                </li>
                <li class="scrollable-container media-list w-100">
                @foreach ($notifications_vendor as $_patient) 
                       ...
                       <a href="#">
                        <div class="media">
                          ...
                          <div class="media-body">
                            <h6 class="media-heading"> حجز جديد من {{$_patients->name}}</h6>
