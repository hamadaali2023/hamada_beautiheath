    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item {{ Request::is('vendors/vendor-orders') ? 'active' : '' }}">
            <a href="{{url('vendors/vendor-orders')}}">
        ...
        <li class="nav-item {{ Request::is('vendors/banks') ? 'active' : '' }}">
            <a href="{{url('vendors/banks')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الحسابات البنكية</span></a>
        </li>
