              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list w-100">
                  ...
                  @foreach ($notifications as $_item) 
                    ...
                    <!--{{url('view/notification/'.$_item->id)}}-->
                      <a href="#">
                        <div class="media">
                          <div class="media-left align-self-center">
                            @if($_item->photo !=null)
                              <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('assets_admin/img/patient/'.$_item->photo) }}" width="50px">
                            @else                                      
                          ...
                          <div class="media-body">
                            <h6 class="media-heading"> new order {{$_item->name}}</h6>
                            <p class="notification-text font-small-3 text-muted">{{$_items->data['message']}}:</p>
                            <small>
                              <time class="media-meta text-muted" datetime="2015-06-11T18:29:20+08:00">{{$_items->data['orderId']}}</time>
                            </small>
                          </div>
                        </div>
                      </a>
                       ...
                       <a href="#">
                        <div class="media">
                          ...
                          <div class="media-body">
                            ...
                            <p class="notification-text font-small-3 text-muted">{{$_patients->data['name']}}:</p>
                            <small>
